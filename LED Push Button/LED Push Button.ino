// Conditions
// 1.Blink LED 1 every second.
//2.Read user input from Serial (number between 0 and 255) and write the data to LED 2.
//3.Power on LED 3 if the push button is pressed.
//4.Power on LED 4 if the potentiometer value is greater than 512.
// 5.Print the potentiometer value via Serial every 2 seconds.
